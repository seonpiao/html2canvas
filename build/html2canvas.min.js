...
*/
!function(a,b,c){"use strict";function d(a,b,c){var d,e=a.runtimeStyle&&a.runtimeStyle[b],f=a.style;return!/^-?[0-9]+\.?[0-9]*(?:px)?$/i.test(c)&&/^-?\d/.test(c)&&(d=f.left,e&&(a.runtimeStyle.left=a.currentStyle.left),f.left="fontSize"===b?"1em":c||0,c=f.pixelLeft+"px",f.left=d,e&&(a.runtimeStyle.left=e)),/^(thin|medium|thick)$/i.test(c)?c:Math.round(parseFloat(c))+"px"}function e(a){return parseInt(a,10)}function f(a,b,e,f){if(a=(a||"").split(","),a=a[f||0]||a[0]||"auto",a=j.Util.trimText(a).split(" "),"backgroundSize"===e&&a[0]&&a[0].match(/^(cover|contain|auto)$/))return a;if(a[0]=-1===a[0].indexOf("%")?d(b,e+"X",a[0]):a[0],a[1]===c){if("backgroundSize"===e)return a[1]="auto",a;a[1]=a[0]}return a[1]=-1===a[1].indexOf("%")?d(b,e+"Y",a[1]):a[1],a}function g(a,b){var c=[];return{storage:c,width:a,height:b,clip:function(){c.push({type:"function",name:"clip",arguments:arguments})},translate:function(){c.push({type:"function",name:"translate",arguments:arguments})},fill:function(){c.push({type:"function",name:"fill",arguments:arguments})},save:function(){c.push({type:"function",name:"save",arguments:arguments})},restore:function(){c.push({type:"function",name:"restore",arguments:arguments})},fillRect:function(){c.push({type:"function",name:"fillRect",arguments:arguments})},createPattern:function(){c.push({type:"function",name:"createPattern",arguments:arguments})},drawShape:function(){var a=[];return c.push({type:"function",name:"drawShape",arguments:a}),{moveTo:function(){a.push({name:"moveTo",arguments:arguments})},lineTo:function(){a.push({name:"lineTo",arguments:arguments})},arcTo:function(){a.push({name:"arcTo",arguments:arguments})},bezierCurveTo:function(){a.push({name:"bezierCurveTo",arguments:arguments})},quadraticCurveTo:function(){a.push({name:"quadraticCurveTo",arguments:arguments})}}},drawImage:function(){c.push({type:"function",name:"drawImage",arguments:arguments})},fillText:function(){c.push({type:"function",name:"fillText",arguments:arguments})},arc:function(){c.push({type:"function",name:"arc",arguments:arguments})},beginPath:function(){c.push({type:"function",name:"beginPath",arguments:arguments})},closePath:function(){c.push({type:"function",name:"closePath",arguments:arguments})},setVariable:function(a,b){return c.push({type:"variable",name:a,arguments:b}),b}}}var h,i,j={};j.Util={},j.Util.log=function(b){j.logging&&a.console&&a.console.log&&a.console.log(b)},j.Util.trimText=function(a){return function(b){return a?a.apply(b):((b||"")+"").replace(/^\s+|\s+$/g,"")}}(String.prototype.trim),j.Util.asFloat=function(a){return parseFloat(a)},function(){var a=/((rgba|rgb)\([^\)]+\)(\s-?\d+px){0,})/g,b=/(-?\d+px)|(#.+)|(rgb\(.+\))|(rgba\(.+\))/g;j.Util.parseTextShadows=function(c){if(!c||"none"===c)return[];for(var d=c.match(a),e=[],f=0;d&&f<d.length;f++){var g=d[f].match(b);e.push({color:g[0],offsetX:g[1]?g[1].replace("px",""):0,offsetY:g[2]?g[2].replace("px",""):0,blur:g[3]?g[3].replace("px",""):0})}return e}}(),j.Util.parseBackgroundImage=function(a){var b,c,d,e,f,g,h,i,j=" \r\n	",k=[],l=0,m=0,n=function(){b&&('"'===c.substr(0,1)&&(c=c.substr(1,c.length-2)),c&&i.push(c),"-"===b.substr(0,1)&&(e=b.indexOf("-",1)+1)>0&&(d=b.substr(0,e),b=b.substr(e)),k.push({prefix:d,method:b.toLowerCase(),value:f,args:i})),i=[],b=d=c=f=""};n();for(var o=0,p=a.length;p>o;o++)if(g=a[o],!(0===l&&j.indexOf(g)>-1)){switch(g){case'"':h?h===g&&(h=null):h=g;break;case"(":if(h)break;if(0===l){l=1,f+=g;continue}m++;break;case")":if(h)break;if(1===l){if(0===m){l=0,f+=g,n();continue}m--}break;case",":if(h)break;if(0===l){n();continue}if(1===l&&0===m&&!b.match(/^url$/i)){i.push(c),c="",f+=g;continue}}f+=g,0===l?b+=g:c+=g}return n(),k},j.Util.Bounds=function(a){var b,c={};return a.getBoundingClientRect&&(b=a.getBoundingClientRect(),c.top=b.top,c.bottom=b.bottom||b.top+b.height,c.left=b.left,c.width=a.offsetWidth,c.height=a.offsetHeight),c},j.Util.OffsetBounds=function(a){var b=a.offsetParent?j.Util.OffsetBounds(a.offsetParent):{top:0,left:0};return{top:a.offsetTop+b.top,bottom:a.offsetTop+a.offsetHeight+b.top,left:a.offsetLeft+b.left,width:a.offsetWidth,height:a.offsetHeight}},j.Util.getCSS=function(a,c,d){h!==a&&(i=b.defaultView.getComputedStyle(a,null));var g=i[c];if(/^background(Size|Position)$/.test(c))return f(g,a,c,d);if(/border(Top|Bottom)(Left|Right)Radius/.test(c)){var j=g.split(" ");return j.length<=1&&(j[1]=j[0]),j.map(e)}return g},j.Util.resizeBounds=function(a,b,c,d,e){var f,g,h=c/d,i=a/b;return e&&"auto"!==e?i>h^"contain"===e?(g=d,f=d*i):(f=c,g=c/i):(f=c,g=d),{width:f,height:g}},j.Util.BackgroundPosition=function(a,b,c,d,e){var f,g,h=j.Util.getCSS(a,"backgroundPosition",d);return 1===h.length&&(h=[h[0],h[0]]),f=-1!==h[0].toString().indexOf("%")?(b.width-(e||c).width)*(parseFloat(h[0])/100):parseInt(h[0],10),g="auto"===h[1]?f/c.width*c.height:-1!==h[1].toString().indexOf("%")?(b.height-(e||c).height)*parseFloat(h[1])/100:parseInt(h[1],10),"auto"===h[0]&&(f=g/c.height*c.width),{left:f,top:g}},j.Util.BackgroundSize=function(a,b,c,d){var e,f,g=j.Util.getCSS(a,"backgroundSize",d);if(1===g.length&&(g=[g[0],g[0]]),-1!==g[0].toString().indexOf("%"))e=b.width*parseFloat(g[0])/100;else if("auto"===g[0])e=c.width;else{if(/contain|cover/.test(g[0])){var h=j.Util.resizeBounds(c.width,c.height,b.width,b.height,g[0]);return{width:h.width,height:h.height}}e=parseInt(g[0],10)}return f="auto"===g[1]?e/c.width*c.height:-1!==g[1].toString().indexOf("%")?b.height*parseFloat(g[1])/100:parseInt(g[1],10),"auto"===g[0]&&(e=f/c.height*c.width),{width:e,height:f}},j.Util.Extend=function(a,b){for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);return b},j.Util.Children=function(a){var b;try{b=a.nodeName&&"IFRAME"===a.nodeName.toUpperCase()?a.contentDocument||a.contentWindow.document:function(a){var b=[];return null!==a&&!function(a,b){var d=a.length,e=0;if("number"==typeof b.length)for(var f=b.length;f>e;e++)a[d++]=b[e];else for(;b[e]!==c;)a[d++]=b[e++];return a.length=d,a}(b,a),b}(a.childNodes)}catch(d){j.Util.log("html2canvas.Util.Children failed with exception: "+d.message),b=[]}return b},j.Util.isTransparent=function(a){return!a||"transparent"===a||"rgba(0, 0, 0, 0)"===a},j.Util.Font=function(){var a={};return function(b,d,e){if(a[b+"-"+d]!==c)return a[b+"-"+d];var f,g,h,i=e.createElement("div"),j=e.createElement("img"),k=e.createElement("span"),l="Hidden Text";return i.style.visibility="hidden",i.style.fontFamily=b,i.style.fontSize=d,i.style.margin=0,i.style.padding=0,e.body.appendChild(i),j.src="data:image/gif;base64,R0lGODlhAQABAIABAP///wAAACwAAAAAAQABAAACAkQBADs=",j.width=1,j.height=1,j.style.margin=0,j.style.padding=0,j.style.verticalAlign="baseline",k.style.fontFamily=b,k.style.fontSize=d,k.style.margin=0,k.style.padding=0,k.appendChild(e.createTextNode(l)),i.appendChild(k),i.appendChild(j),f=j.offsetTop-k.offsetTop+1,i.removeChild(k),i.appendChild(e.createTextNode(l)),i.style.lineHeight="normal",j.style.verticalAlign="super",g=j.offsetTop-i.offsetTop+1,h={baseline:f,lineWidth:1,middle:g},a[b+"-"+d]=h,e.body.removeChild(i),h}}(),function(){function a(a){return function(b){try{a.addColorStop(b.stop,b.color)}catch(d){c.log(["failed to add color stop: ",d,"; tried to add: ",b])}}}var c=j.Util,d={};j.Generate=d;var e=[/^(-webkit-linear-gradient)\(([a-z\s]+)([\w\d\.\s,%\(\)]+)\)$/,/^(-o-linear-gradient)\(([a-z\s]+)([\w\d\.\s,%\(\)]+)\)$/,/^(-webkit-gradient)\((linear|radial),\s((?:\d{1,3}%?)\s(?:\d{1,3}%?),\s(?:\d{1,3}%?)\s(?:\d{1,3}%?))([\w\d\.\s,%\(\)\-]+)\)$/,/^(-moz-linear-gradient)\(((?:\d{1,3}%?)\s(?:\d{1,3}%?))([\w\d\.\s,%\(\)]+)\)$/,/^(-webkit-radial-gradient)\(((?:\d{1,3}%?)\s(?:\d{1,3}%?)),\s(\w+)\s([a-z\-]+)([\w\d\.\s,%\(\)]+)\)$/,/^(-moz-radial-gradient)\(((?:\d{1,3}%?)\s(?:\d{1,3}%?)),\s(\w+)\s?([a-z\-]*)([\w\d\.\s,%\(\)]+)\)$/,/^(-o-radial-gradient)\(((?:\d{1,3}%?)\s(?:\d{1,3}%?)),\s(\w+)\s([a-z\-]+)([\w\d\.\s,%\(\)]+)\)$/];d.parseGradient=function(a,b){var c,d,f,g,h,i,j,k,l,m,n,o,p=e.length;for(d=0;p>d&&!(f=a.match(e[d]));d+=1);if(f)switch(f[1]){case"-webkit-linear-gradient":case"-o-linear-gradient":if(c={type:"linear",x0:null,y0:null,x1:null,y1:null,colorStops:[]},h=f[2].match(/\w+/g))for(i=h.length,d=0;i>d;d+=1)switch(h[d]){case"top":c.y0=0,c.y1=b.height;break;case"right":c.x0=b.width,c.x1=0;break;case"bottom":c.y0=b.height,c.y1=0;break;case"left":c.x0=0,c.x1=b.width}if(null===c.x0&&null===c.x1&&(c.x0=c.x1=b.width/2),null===c.y0&&null===c.y1&&(c.y0=c.y1=b.height/2),h=f[3].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}(?:%|px))?)+/g))for(i=h.length,j=1/Math.max(i-1,1),d=0;i>d;d+=1)k=h[d].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/),k[2]?(g=parseFloat(k[2]),g/="%"===k[3]?100:b.width):g=d*j,c.colorStops.push({color:k[1],stop:g});break;case"-webkit-gradient":if(c={type:"radial"===f[2]?"circle":f[2],x0:0,y0:0,x1:0,y1:0,colorStops:[]},h=f[3].match(/(\d{1,3})%?\s(\d{1,3})%?,\s(\d{1,3})%?\s(\d{1,3})%?/),h&&(c.x0=h[1]*b.width/100,c.y0=h[2]*b.height/100,c.x1=h[3]*b.width/100,c.y1=h[4]*b.height/100),h=f[4].match(/((?:from|to|color-stop)\((?:[0-9\.]+,\s)?(?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)\))+/g))for(i=h.length,d=0;i>d;d+=1)k=h[d].match(/(from|to|color-stop)\(([0-9\.]+)?(?:,\s)?((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\)/),g=parseFloat(k[2]),"from"===k[1]&&(g=0),"to"===k[1]&&(g=1),c.colorStops.push({color:k[3],stop:g});break;case"-moz-linear-gradient":if(c={type:"linear",x0:0,y0:0,x1:0,y1:0,colorStops:[]},h=f[2].match(/(\d{1,3})%?\s(\d{1,3})%?/),h&&(c.x0=h[1]*b.width/100,c.y0=h[2]*b.height/100,c.x1=b.width-c.x0,c.y1=b.height-c.y0),h=f[3].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}%)?)+/g))for(i=h.length,j=1/Math.max(i-1,1),d=0;i>d;d+=1)k=h[d].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%)?/),k[2]?(g=parseFloat(k[2]),k[3]&&(g/=100)):g=d*j,c.colorStops.push({color:k[1],stop:g});break;case"-webkit-radial-gradient":case"-moz-radial-gradient":case"-o-radial-gradient":if(c={type:"circle",x0:0,y0:0,x1:b.width,y1:b.height,cx:0,cy:0,rx:0,ry:0,colorStops:[]},h=f[2].match(/(\d{1,3})%?\s(\d{1,3})%?/),h&&(c.cx=h[1]*b.width/100,c.cy=h[2]*b.height/100),h=f[3].match(/\w+/),k=f[4].match(/[a-z\-]*/),h&&k)switch(k[0]){case"farthest-corner":case"cover":case"":l=Math.sqrt(Math.pow(c.cx,2)+Math.pow(c.cy,2)),m=Math.sqrt(Math.pow(c.cx,2)+Math.pow(c.y1-c.cy,2)),n=Math.sqrt(Math.pow(c.x1-c.cx,2)+Math.pow(c.y1-c.cy,2)),o=Math.sqrt(Math.pow(c.x1-c.cx,2)+Math.pow(c.cy,2)),c.rx=c.ry=Math.max(l,m,n,o);break;case"closest-corner":l=Math.sqrt(Math.pow(c.cx,2)+Math.pow(c.cy,2)),m=Math.sqrt(Math.pow(c.cx,2)+Math.pow(c.y1-c.cy,2)),n=Math.sqrt(Math.pow(c.x1-c.cx,2)+Math.pow(c.y1-c.cy,2)),o=Math.sqrt(Math.pow(c.x1-c.cx,2)+Math.pow(c.cy,2)),c.rx=c.ry=Math.min(l,m,n,o);break;case"farthest-side":"circle"===h[0]?c.rx=c.ry=Math.max(c.cx,c.cy,c.x1-c.cx,c.y1-c.cy):(c.type=h[0],c.rx=Math.max(c.cx,c.x1-c.cx),c.ry=Math.max(c.cy,c.y1-c.cy));break;case"closest-side":case"contain":"circle"===h[0]?c.rx=c.ry=Math.min(c.cx,c.cy,c.x1-c.cx,c.y1-c.cy):(c.type=h[0],c.rx=Math.min(c.cx,c.x1-c.cx),c.ry=Math.min(c.cy,c.y1-c.cy))}if(h=f[5].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}(?:%|px))?)+/g))for(i=h.length,j=1/Math.max(i-1,1),d=0;i>d;d+=1)k=h[d].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/),k[2]?(g=parseFloat(k[2]),g/="%"===k[3]?100:b.width):g=d*j,c.colorStops.push({color:k[1],stop:g})}return c},d.Gradient=function(c,d){if(0!==d.width&&0!==d.height){var e,f,g=b.createElement("canvas"),h=g.getContext("2d");if(g.width=d.width,g.height=d.height,e=j.Generate.parseGradient(c,d))switch(e.type){case"linear":f=h.createLinearGradient(e.x0,e.y0,e.x1,e.y1),e.colorStops.forEach(a(f)),h.fillStyle=f,h.fillRect(0,0,d.width,d.height);break;case"circle":f=h.createRadialGradient(e.cx,e.cy,0,e.cx,e.cy,e.rx),e.colorStops.forEach(a(f)),h.fillStyle=f,h.fillRect(0,0,d.width,d.height);break;case"ellipse":var i=b.createElement("canvas"),k=i.getContext("2d"),l=Math.max(e.rx,e.ry),m=2*l;i.width=i.height=m,f=k.createRadialGradient(e.rx,e.ry,0,e.rx,e.ry,l),e.colorStops.forEach(a(f)),k.fillStyle=f,k.fillRect(0,0,m,m),h.fillStyle=e.colorStops[e.colorStops.length-1].color,h.fillRect(0,0,g.width,g.height),h.drawImage(i,e.cx-e.rx,e.cy-e.ry,2*e.rx,2*e.ry)}return g}},d.ListAlpha=function(a){var b,c="";do b=a%26,c=String.fromCharCode(b+64)+c,a/=26;while(26*a>26);return c},d.ListRoman=function(a){var b,c=["M","CM","D","CD","C","XC","L","XL","X","IX","V","IV","I"],d=[1e3,900,500,400,100,90,50,40,10,9,5,4,1],e="",f=c.length;if(0>=a||a>=4e3)return a;for(b=0;f>b;b+=1)for(;a>=d[b];)a-=d[b],e+=c[b];return e}}(),j.Parse=function(d,e,f){function h(){var a=vb(b.documentElement,"backgroundColor"),c=rb.isTransparent(a)&&ob===b.body,d=kb(ob,null,!1,c);i(ob),nb(ob,d,function(){c&&(a=d.backgroundColor),k(),rb.log("Done parsing, moving to Render."),f({backgroundColor:a,stack:d})})}function i(a){function c(){for(var a=/:before|:after/,c=b.styleSheets,d=0,e=c.length;e>d;d++)try{for(var f=c[d].cssRules,g=0,i=f.length;i>g;g++)a.test(f[g].selectorText)&&h.push(f[g].selectorText)}catch(j){}for(d=0,e=h.length;e>d;d++)h[d]=h[d].match(/(^[^:]*)/)[1]}function d(){for(var a=b.querySelectorAll(h.join(",")),c=0,d=a.length;d>c;c++)e(a[c])}function e(a){var b=Y(a,":before"),c=Y(a,":after");b&&g.push({type:"before",pseudo:b,el:a}),c&&g.push({type:"after",pseudo:c,el:a})}function f(){g.forEach(function(a){l(a.el,wb+"-parent")}),g.forEach(function(a){"before"===a.type?a.el.insertBefore(a.pseudo,a.el.firstChild):a.el.appendChild(a.pseudo)})}var g=[],h=[];c(),d(a),f()}function k(){ub.removeChild(xb);for(var a=b.getElementsByClassName(wb+"-element");a.length;)a[0].parentNode.removeChild(a[0]);for(var c=b.getElementsByClassName(wb+"-parent");c.length;)m(c[0],wb+"-parent")}function l(a,b){a.classList?a.classList.add(b):a.className=a.className+" "+b}function m(a,b){a.classList?a.classList.remove(b):a.className=a.className.replace(b,"").trim()}function n(){return Math.max(Math.max(qb.body.scrollWidth,qb.documentElement.scrollWidth),Math.max(qb.body.offsetWidth,qb.documentElement.offsetWidth),Math.max(qb.body.clientWidth,qb.documentElement.clientWidth))}function o(){return Math.max(Math.max(qb.body.scrollHeight,qb.documentElement.scrollHeight),Math.max(qb.body.offsetHeight,qb.documentElement.offsetHeight),Math.max(qb.body.clientHeight,qb.documentElement.clientHeight))}function p(a,b){var c=parseInt(vb(a,b),10);return isNaN(c)?0:c}function q(a,b,c,d,e,f){"transparent"!==f&&(a.setVariable("fillStyle",f),a.fillRect(b,c,d,e),pb+=1)}function r(a,b,c){return a.length>0?b+c.toUpperCase():void 0}function s(a,b){switch(b){case"lowercase":return a.toLowerCase();case"capitalize":return a.replace(/(^|\s|:|-|\(|\))([a-z])/g,r);case"uppercase":return a.toUpperCase();default:return a}}function t(a){return/^(normal|none|0px)$/.test(a)}function u(a,b,c,d){null!==a&&rb.trimText(a).length>0&&(d.fillText(a,b,c),pb+=1)}function v(a,b,c){c.setVariable("fillStyle","#000000"),c.beginPath();var d=3;c.arc(a,b-2*d,d,0,2*Math.PI,!0),c.closePath(),c.fill(),pb+=1}function w(a,b,c,d){var e=!1,f=vb(b,"fontWeight"),g=vb(b,"fontFamily"),h=vb(b,"fontSize"),i=rb.parseTextShadows(vb(b,"textShadow"));switch(parseInt(f,10)){case 401:f="bold";break;case 400:f="normal"}return a.setVariable("fillStyle",d),a.setVariable("font",[vb(b,"fontStyle"),vb(b,"fontVariant"),f,h,g].join(" ")),a.setVariable("textAlign",e?"right":"left"),i.length&&(a.setVariable("shadowColor",i[0].color),a.setVariable("shadowOffsetX",i[0].offsetX),a.setVariable("shadowOffsetY",i[0].offsetY),a.setVariable("shadowBlur",i[0].blur)),"none"!==c?rb.Font(g,h,qb):void 0}function x(a,b,c,d,e){switch(b){case"underline":q(a,c.left,Math.round(c.top+d.baseline+d.lineWidth),c.width,1,e);break;case"overline":q(a,c.left,Math.round(c.top),c.width,1,e);break;case"line-through":q(a,c.left,Math.ceil(c.top+d.middle+d.lineWidth),c.width,1,e)}}function y(a,b,c,d,e){var f;if(sb.rangeBounds&&!e)("none"!==c||0!==rb.trimText(b).length)&&(f=z(b,a.node,a.textOffset)),a.textOffset+=b.length;else if(a.node&&"string"==typeof a.node.nodeValue){var g=d?a.node.splitText(b.length):null;f=A(a.node,e),a.node=g}return f}function z(a,b,c){var d=qb.createRange();return d.setStart(b,c),d.setEnd(b,c+a.length),d.getBoundingClientRect()}function A(a,b){var c=a.parentNode,d=qb.createElement("wrapper"),e=a.cloneNode(!0);d.appendChild(a.cloneNode(!0)),c.replaceChild(d,a);var f=b?rb.OffsetBounds(d):rb.Bounds(d);return c.replaceChild(e,d),f}function B(a,b,c){var d,f,g=c.ctx,h=vb(a,"color"),i=vb(a,"textDecoration"),j=vb(a,"textAlign"),k={node:b,textOffset:0};rb.trimText(b.nodeValue).length>0&&(b.nodeValue=s(b.nodeValue,vb(a,"textTransform")),j=j.replace(["-webkit-auto"],["auto"]),f=!e.letterRendering&&/^(left|right|justify|auto)$/.test(j)&&t(vb(a,"letterSpacing"))?b.nodeValue.split(/(\b| )/):b.nodeValue.split(""),d=w(g,a,i,h),e.chinese&&f.forEach(function(a,b){/.*[\u4E00-\u9FA5].*$/.test(a)&&(a=a.split(""),a.unshift(b,1),f.splice.apply(f,a))}),f.forEach(function(a,b){var e=y(k,a,i,b<f.length-1,c.transform.matrix);e&&(u(a,e.left,e.bottom,g),x(g,i,e,d,h))}))}function C(a,b){var c,d,e=qb.createElement("boundelement");return e.style.display="inline",c=a.style.listStyleType,a.style.listStyleType="none",e.appendChild(qb.createTextNode(b)),a.insertBefore(e,a.firstChild),d=rb.Bounds(e),a.removeChild(e),a.style.listStyleType=c,d}function D(a){var b=-1,c=1,d=a.parentNode.childNodes;if(a.parentNode){for(;d[++b]!==a;)1===d[b].nodeType&&c++;return c}return-1}function E(a,b){var c,d=D(a);switch(b){case"decimal":c=d;break;case"decimal-leading-zero":c=1===d.toString().length?d="0"+d.toString():d.toString();break;case"upper-roman":c=j.Generate.ListRoman(d);break;case"lower-roman":c=j.Generate.ListRoman(d).toLowerCase();break;case"lower-alpha":c=j.Generate.ListAlpha(d).toLowerCase();break;case"upper-alpha":c=j.Generate.ListAlpha(d)}return c+". "}function F(a,b,c){var d,e,f,g=b.ctx,h=vb(a,"listStyleType");if(/^(decimal|decimal-leading-zero|upper-alpha|upper-latin|upper-roman|lower-alpha|lower-greek|lower-latin|lower-roman)$/i.test(h)){if(e=E(a,h),f=C(a,e),w(g,a,"none",vb(a,"color")),"inside"!==vb(a,"listStylePosition"))return;g.setVariable("textAlign","left"),d=c.left,u(e,d,f.bottom,g)}else if(/^(disc)$/i.test(h)){if(f=C(a,e),w(g,a,"none",vb(a,"color")),"inside"!==vb(a,"listStylePosition"))return;g.setVariable("textAlign","left"),d=c.left,v(d,f.bottom,g)}}function G(a){var b=d[a];return b&&b.succeeded===!0?b.img:!1}function H(a,b){var c=Math.max(a.left,b.left),d=Math.max(a.top,b.top),e=Math.min(a.left+a.width,b.left+b.width),f=Math.min(a.top+a.height,b.top+b.height);return{left:c,top:d,width:e-c,height:f-d}}function I(a,b,c){var d,e="static"!==b.cssPosition,f=e?vb(a,"zIndex"):"auto",g=vb(a,"opacity"),h="none"!==vb(a,"cssFloat");b.zIndex=d=J(f),d.isPositioned=e,d.isFloated=h,d.opacity=g,d.ownStacking="auto"!==f||1>g,d.depth=c?c.zIndex.depth+1:0,c&&c.zIndex.children.push(b)}function J(a){return{depth:0,zindex:a,children:[]}}function K(a,b,c,d,e){var f=p(b,"paddingLeft"),g=p(b,"paddingTop"),h=p(b,"paddingRight"),i=p(b,"paddingBottom");X(a,c,0,0,c.width,c.height,d.left+f+e[3].width,d.top+g+e[0].width,d.width-(e[1].width+e[3].width+f+h),d.height-(e[0].width+e[2].width+g+i))}function L(a){return["Top","Right","Bottom","Left"].map(function(b){return{width:p(a,"border"+b+"Width"),color:vb(a,"border"+b+"Color")}})}function M(a){return["TopLeft","TopRight","BottomRight","BottomLeft"].map(function(b){return vb(a,"border"+b+"Radius")})}function N(a,b,c,d){var e=4*((Math.sqrt(2)-1)/3),f=c*e,g=d*e,h=a+c,i=b+d;return{topLeft:O({x:a,y:i},{x:a,y:i-g},{x:h-f,y:b},{x:h,y:b}),topRight:O({x:a,y:b},{x:a+f,y:b},{x:h,y:i-g},{x:h,y:i}),bottomRight:O({x:h,y:b},{x:h,y:b+g},{x:a+f,y:i},{x:a,y:i}),bottomLeft:O({x:h,y:i},{x:h-f,y:i},{x:a,y:b+g},{x:a,y:b})}}function O(a,b,c,d){var e=function(a,b,c){return{x:a.x+(b.x-a.x)*c,y:a.y+(b.y-a.y)*c}};return{start:a,startControl:b,endControl:c,end:d,subdivide:function(f){var g=e(a,b,f),h=e(b,c,f),i=e(c,d,f),j=e(g,h,f),k=e(h,i,f),l=e(j,k,f);return[O(a,g,j,l),O(l,k,i,d)]},curveTo:function(a){a.push(["bezierCurve",b.x,b.y,c.x,c.y,d.x,d.y])},curveToReversed:function(d){d.push(["bezierCurve",c.x,c.y,b.x,b.y,a.x,a.y])}}}function P(a,b,c,d,e,f,g){b[0]>0||b[1]>0?(a.push(["line",d[0].start.x,d[0].start.y]),d[0].curveTo(a),d[1].curveTo(a)):a.push(["line",f,g]),(c[0]>0||c[1]>0)&&a.push(["line",e[0].start.x,e[0].start.y])}function Q(a,b,c,d,e,f,g){var h=[];return b[0]>0||b[1]>0?(h.push(["line",d[1].start.x,d[1].start.y]),d[1].curveTo(h)):h.push(["line",a.c1[0],a.c1[1]]),c[0]>0||c[1]>0?(h.push(["line",f[0].start.x,f[0].start.y]),f[0].curveTo(h),h.push(["line",g[0].end.x,g[0].end.y]),g[0].curveToReversed(h)):(h.push(["line",a.c2[0],a.c2[1]]),h.push(["line",a.c3[0],a.c3[1]])),b[0]>0||b[1]>0?(h.push(["line",e[1].end.x,e[1].end.y]),e[1].curveToReversed(h)):h.push(["line",a.c4[0],a.c4[1]]),h}function R(a,b,c){var d=a.left,e=a.top,f=a.width,g=a.height,h=b[0][0],i=b[0][1],j=b[1][0],k=b[1][1],l=b[2][0],m=b[2][1],n=b[3][0],o=b[3][1],p=f-j,q=g-m,r=f-l,s=g-o;return{topLeftOuter:N(d,e,h,i).topLeft.subdivide(.5),topLeftInner:N(d+c[3].width,e+c[0].width,Math.max(0,h-c[3].width),Math.max(0,i-c[0].width)).topLeft.subdivide(.5),topRightOuter:N(d+p,e,j,k).topRight.subdivide(.5),topRightInner:N(d+Math.min(p,f+c[3].width),e+c[0].width,p>f+c[3].width?0:j-c[3].width,k-c[0].width).topRight.subdivide(.5),bottomRightOuter:N(d+r,e+q,l,m).bottomRight.subdivide(.5),bottomRightInner:N(d+Math.min(r,f+c[3].width),e+Math.min(q,g+c[0].width),Math.max(0,l-c[1].width),Math.max(0,m-c[2].width)).bottomRight.subdivide(.5),bottomLeftOuter:N(d,e+s,n,o).bottomLeft.subdivide(.5),bottomLeftInner:N(d+c[3].width,e+s,Math.max(0,n-c[3].width),Math.max(0,o-c[2].width)).bottomLeft.subdivide(.5)}}function S(a,b,c,d,e){var f=vb(a,"backgroundClip"),g=[];switch(f){case"content-box":case"padding-box":P(g,d[0],d[1],b.topLeftInner,b.topRightInner,e.left+c[3].width,e.top+c[0].width),P(g,d[1],d[2],b.topRightInner,b.bottomRightInner,e.left+e.width-c[1].width,e.top+c[0].width),P(g,d[2],d[3],b.bottomRightInner,b.bottomLeftInner,e.left+e.width-c[1].width,e.top+e.height-c[2].width),P(g,d[3],d[0],b.bottomLeftInner,b.topLeftInner,e.left+c[3].width,e.top+e.height-c[2].width);break;default:P(g,d[0],d[1],b.topLeftOuter,b.topRightOuter,e.left,e.top),P(g,d[1],d[2],b.topRightOuter,b.bottomRightOuter,e.left+e.width,e.top),P(g,d[2],d[3],b.bottomRightOuter,b.bottomLeftOuter,e.left+e.width,e.top+e.height),P(g,d[3],d[0],b.bottomLeftOuter,b.topLeftOuter,e.left,e.top+e.height)}return g}function T(a,b,c){var d,e,f,g,h,i,j=b.left,k=b.top,l=b.width,m=b.height,n=M(a),o=R(b,n,c),p={clip:S(a,o,c,n,b),borders:[]};for(d=0;4>d;d++)if(c[d].width>0){switch(e=j,f=k,g=l,h=m-c[2].width,d){case 0:h=c[0].width,i=Q({c1:[e,f],c2:[e+g,f],c3:[e+g-c[1].width,f+h],c4:[e+c[3].width,f+h]},n[0],n[1],o.topLeftOuter,o.topLeftInner,o.topRightOuter,o.topRightInner);break;case 1:e=j+l-c[1].width,g=c[1].width,i=Q({c1:[e+g,f],c2:[e+g,f+h+c[2].width],c3:[e,f+h],c4:[e,f+c[0].width]},n[1],n[2],o.topRightOuter,o.topRightInner,o.bottomRightOuter,o.bottomRightInner);break;case 2:f=f+m-c[2].width,h=c[2].width,i=Q({c1:[e+g,f+h],c2:[e,f+h],c3:[e+c[3].width,f],c4:[e+g-c[3].width,f]},n[2],n[3],o.bottomRightOuter,o.bottomRightInner,o.bottomLeftOuter,o.bottomLeftInner);break;case 3:g=c[3].width,i=Q({c1:[e,f+h+c[2].width],c2:[e,f],c3:[e+g,f+c[0].width],c4:[e+g,f+h]},n[3],n[0],o.bottomLeftOuter,o.bottomLeftInner,o.topLeftOuter,o.topLeftInner)}p.borders.push({args:i,color:c[d].color})}return p}function U(a,b){var c=a.drawShape();return b.forEach(function(a,b){c[0===b?"moveTo":a[0]+"To"].apply(null,a.slice(1))}),c}function V(a,b,c){"transparent"!==c&&(a.setVariable("fillStyle",c),U(a,b),a.fill(),pb+=1)}function W(a,b,c){var d,e,f=qb.createElement("valuewrap"),g=["lineHeight","textAlign","fontFamily","color","fontSize","paddingLeft","paddingTop","width","height","border","borderLeftWidth","borderTopWidth"];g.forEach(function(b){try{f.style[b]=vb(a,b)}catch(c){rb.log("html2canvas: Parse: Exception caught in renderFormValue: "+c.message)}}),f.style.borderColor="black",f.style.borderStyle="solid",f.style.display="block",f.style.position="absolute",(/^(submit|reset|button|text|password)$/.test(a.type)||"SELECT"===a.nodeName)&&(f.style.lineHeight=vb(a,"height")),f.style.top=b.top+"px",f.style.left=b.left+"px",d="SELECT"===a.nodeName?(a.options[a.selectedIndex]||0).text:a.value,d||(d=a.placeholder),e=qb.createTextNode(d),f.appendChild(e),ub.appendChild(f),B(a,e,c),ub.removeChild(f)}function X(a){a.drawImage.apply(a,Array.prototype.slice.call(arguments,1)),pb+=1}function Y(c,d){var e=a.getComputedStyle(c,d),f=a.getComputedStyle(c);if(e&&e.content&&"none"!==e.content&&"-moz-alt-content"!==e.content&&"none"!==e.display&&f.content!==e.content){var g=e.content+"";("'"===g[0]||'"'===g[0])&&(g=g.replace(/(^['"])|(['"]$)/g,""));var h="url"===g.substr(0,3),i=b.createElement(h?"img":"span");return i.className=wb+"-element ",Object.keys(e).filter(Z).forEach(function(a){try{i.style[a]=e[a]}catch(b){rb.log(["Tried to assign readonly property ",a,"Error:",b])}}),h?i.src=rb.parseBackgroundImage(g)[0].args[0]:i.innerHTML=g,i}}function Z(b){return isNaN(a.parseInt(b,10))}function $(a,b,c,d){var e=Math.round(d.left+c.left),f=Math.round(d.top+c.top);a.createPattern(b),a.translate(e,f),a.fill(),a.translate(-e,-f)}function _(a,b,c,d,e,f,g,h){var i=[];i.push(["line",Math.round(e),Math.round(f)]),i.push(["line",Math.round(e+g),Math.round(f)]),i.push(["line",Math.round(e+g),Math.round(h+f)]),i.push(["line",Math.round(e),Math.round(h+f)]),U(a,i),a.save(),a.clip(),$(a,b,c,d),a.restore()}function ab(a,b,c){q(a,b.left,b.top,b.width,b.height,c)}function bb(a,b,c,d,e){var f=rb.BackgroundSize(a,b,d,e),g=rb.BackgroundPosition(a,b,d,e,f),h=vb(a,"backgroundRepeat").split(",").map(rb.trimText);switch(d=db(d,f),h=h[e]||h[0]){case"repeat-x":_(c,d,g,b,b.left,b.top+g.top,99999,d.height);break;case"repeat-y":_(c,d,g,b,b.left+g.left,b.top,d.width,99999);break;case"no-repeat":_(c,d,g,b,b.left+g.left,b.top+g.top,d.width,d.height);break;default:$(c,d,g,{top:b.top,left:b.left,width:d.width,height:d.height})}}function cb(a,b,c){for(var d,e=vb(a,"backgroundImage"),f=rb.parseBackgroundImage(e),g=f.length;g--;)if(e=f[g],e.args&&0!==e.args.length){var h="url"===e.method?e.args[0]:e.value;d=G(h),d?bb(a,b,c,d,g):rb.log("html2canvas: Error loading background:",e)}}function db(a,b){if(a.width===b.width&&a.height===b.height)return a;var c,d=qb.createElement("canvas");return d.width=b.width,d.height=b.height,c=d.getContext("2d"),X(c,a,0,0,a.width,a.height,0,0,b.width,b.height),d}function eb(a,b,c){return a.setVariable("globalAlpha",vb(b,"opacity")*(c?c.opacity:1))}function fb(a){return a.replace("px","")}function gb(a){var b=/(matrix)\((.+)\)/,c=vb(a,"transform")||vb(a,"-webkit-transform")||vb(a,"-moz-transform")||vb(a,"-ms-transform")||vb(a,"-o-transform"),d=vb(a,"transform-origin")||vb(a,"-webkit-transform-origin")||vb(a,"-moz-transform-origin")||vb(a,"-ms-transform-origin")||vb(a,"-o-transform-origin")||"0px 0px";d=d.split(" ").map(fb).map(rb.asFloat);var e;if(c&&"none"!==c){var f=c.match(b);if(f)switch(f[1]){case"matrix":e=f[2].split(",").map(rb.trimText).map(rb.asFloat)}}return{origin:d,matrix:e}}function hb(a,b,c,d){var f=g(b?c.width:n(),b?c.height:o()),h={ctx:f,opacity:eb(f,a,b),cssPosition:vb(a,"position"),borders:L(a),transform:d,clip:b&&b.clip?rb.Extend({},b.clip):null};return I(a,h,b),e.useOverflow===!0&&/(hidden|scroll|auto)/.test(vb(a,"overflow"))===!0&&/(BODY)/i.test(a.nodeName)===!1&&(h.clip=h.clip?H(h.clip,c):c),h}function ib(a,b,c){var d={left:b.left+a[3].width,top:b.top+a[0].width,width:b.width-(a[1].width+a[3].width),height:b.height-(a[0].width+a[2].width)};return c&&(d=H(d,c)),d}function jb(a,b){var c=b.matrix?rb.OffsetBounds(a):rb.Bounds(a);return b.origin[0]+=c.left,b.origin[1]+=c.top,c}function kb(a,b,c){var d,e=gb(a,b),f=jb(a,e),g=hb(a,b,f,e),h=g.borders,i=g.ctx,j=ib(h,f,g.clip),k=T(a,f,h),l=tb.test(a.nodeName)?"#efefef":vb(a,"backgroundColor");switch(U(i,k.clip),i.save(),i.clip(),j.height>0&&j.width>0&&!c?(ab(i,f,l),cb(a,j,i)):c&&(g.backgroundColor=l),i.restore(),k.borders.forEach(function(a){V(i,a.args,a.color)}),a.nodeName){case"IMG":(d=G(a.getAttribute("src")))?K(i,a,d,f,h):rb.log("html2canvas: Error loading <img>:"+a.getAttribute("src"));break;case"INPUT":/^(text|url|email|submit|button|reset)$/.test(a.type)&&(a.value||a.placeholder||"").length>0&&W(a,f,g);break;case"TEXTAREA":(a.value||a.placeholder||"").length>0&&W(a,f,g);break;case"SELECT":(a.options||a.placeholder||"").length>0&&W(a,f,g);break;case"LI":F(a,g,j);break;case"CANVAS":K(i,a,a,f,h)}return g}function lb(a){return"none"!==vb(a,"display")&&"hidden"!==vb(a,"visibility")&&!a.hasAttribute("data-html2canvas-ignore")}function mb(a,b,c){return c||(c=function(){}),lb(a)&&(b=kb(a,b,!1)||b,!tb.test(a.nodeName))?nb(a,b,c):(c(),void 0)}function nb(a,b,c){function d(c){c.nodeType===c.ELEMENT_NODE?mb(c,b,f):c.nodeType===c.TEXT_NODE?(B(a,c,b),f()):f()}function f(){--h<=0&&(rb.log("finished rendering "+g.length+" children."),c())}var g=rb.Children(a),h=g.length+1;f(),e.async?g.forEach(function(a){setTimeout(function(){d(a)},0)}):g.forEach(d)}a.scroll(0,0);var ob=e.elements===c?b.body:e.elements[0],pb=0,qb=ob.ownerDocument,rb=j.Util,sb=rb.Support(e,qb),tb=new RegExp("("+e.ignoreElements+")"),ub=qb.body,vb=rb.getCSS,wb="___html2canvas___pseudoelement",xb=qb.createElement("style");xb.innerHTML="."+wb+'-parent:before { content: "" !important; display: none !important; }.'+wb+'-parent:after { content: "" !important; display: none !important; }',ub.appendChild(xb),d=d||{},h()},j.Preload=function(d){function e(a){A.href=a,A.href=A.href;var b=A.protocol+A.host;return b===p}function f(){u.log("html2canvas: start: images: "+t.numLoaded+" / "+t.numTotal+" (failed: "+t.numFailed+")"),!t.firstRun&&t.numLoaded>=t.numTotal&&(u.log("Finished loading images: # "+t.numTotal+" (failed: "+t.numFailed+")"),"function"==typeof d.complete&&d.complete(t))}function g(b,e,g){var h,i,j=d.proxy;A.href=b,b=A.href,h="html2canvas_"+v++,g.callbackname=h,j+=j.indexOf("?")>-1?"&":"?",j+="url="+encodeURIComponent(b)+"&callback="+h,i=x.createElement("script"),a[h]=function(b){"error:"===b.substring(0,6)?(g.succeeded=!1,t.numLoaded++,t.numFailed++,f()):(o(e,g),e.src=b),a[h]=c;try{delete a[h]}catch(d){}i.parentNode.removeChild(i),i=null,delete g.script,delete g.callbackname},i.setAttribute("type","text/javascript"),i.setAttribute("src",j),g.script=i,a.document.body.appendChild(i)}function h(b,c){var d=a.getComputedStyle(b,c),e=d.content;"url"===e.substr(0,3)&&q.loadImage(j.Util.parseBackgroundImage(e)[0].args[0]),m(d.backgroundImage,b)}function i(a){h(a,":before"),h(a,":after")}function k(a,b){var d=j.Generate.Gradient(a,b);d!==c&&(t[a]={img:d,succeeded:!0},t.numTotal++,t.numLoaded++,f())}function l(a){return a&&a.method&&a.args&&a.args.length>0}function m(a,b){var d;j.Util.parseBackgroundImage(a).filter(l).forEach(function(a){"url"===a.method?q.loadImage(a.args[0]):a.method.match(/\-?gradient$/)&&(d===c&&(d=j.Util.Bounds(b)),k(a.value,d))})}function n(a){var b=!1;try{u.Children(a).forEach(n)}catch(d){}try{b=a.nodeType}catch(e){b=!1,u.log("html2canvas: failed to access some element's nodeType - Exception: "+e.message)}if(1===b||b===c){i(a);try{m(u.getCSS(a,"backgroundImage"),a)}catch(d){u.log("html2canvas: failed to get background-image - Exception: "+d.message)}m(a)}}function o(b,e){b.onload=function(){e.timer!==c&&a.clearTimeout(e.timer),t.numLoaded++,e.succeeded=!0,b.onerror=b.onload=null,f()},b.onerror=function(){if("anonymous"===b.crossOrigin&&(a.clearTimeout(e.timer),d.proxy)){var c=b.src;return b=new Image,e.img=b,b.src=c,g(b.src,b,e),void 0}t.numLoaded++,t.numFailed++,e.succeeded=!1,b.onerror=b.onload=null,f()}}var p,q,r,s,t={numLoaded:0,numFailed:0,numTotal:0,cleanupDone:!1},u=j.Util,v=0,w=d.elements[0]||b.body,x=w.ownerDocument,y=w.getElementsByTagName("img"),z=y.length,A=x.createElement("a"),B=function(a){return a.crossOrigin!==c
